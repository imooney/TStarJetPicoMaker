...
TStarJetPicoTower::TStarJetPicoTower(TStarJetPicoTower &t)
  : TObject(t)
...
void TStarJetPicoTower::Clear(Option_t */*Option*/)
{
  //
  // Clear everything
  // 
...
void TStarJetPicoTower::AddMatchedTrack(Int_t idx)
{
  //
  // Add new index
